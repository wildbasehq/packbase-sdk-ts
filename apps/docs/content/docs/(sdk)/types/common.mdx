...
The SDK does not maintain its own response cache. Add response caching in your application's data layer when needed.
...
`signal` cancels native fetches and howl polling.
